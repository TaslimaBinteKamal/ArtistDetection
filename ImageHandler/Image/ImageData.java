...
public class ImageData {
	...
	File file;
	String imageFolderPath = "D:\\ShaansDrawer\\Semester6\\AI\\Image datset 2\\ZainulAbedin\\ZA_edge";
	String pixelFolderPath = "D:\\ShaansDrawer\\Semester6\\AI\\Image datset 2\\ZainulAbedin\\ZA_edgeValue\\";
	...
	public void getPixels() throws IOException {
		...
		for(File f1: file.listFiles()) {
			...
			FileWriter outputFile = new FileWriter(new File(pixelFolderPath+f1.getName()+"edg"+".csv"));
